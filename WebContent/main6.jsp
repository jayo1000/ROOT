...
<h2 style="font-size: 40px;">직장인대출</h2>
<h6 style="margin-top: 20px; color:#8c8c8c; size: 1px;">직장인 고객을 위한 맞춤대출</h6>
...
<!-- 서브 컨텐츠 내용 시작 -->
	...
	<li style="list-style: none; color: #808080">재직확인이 가능한 직장인</li>       
	<li style="list-style: none; color: #808080">(4대보험 미가입자는 통장수령으로 가능)</li>	
	</ul>
	</label>
