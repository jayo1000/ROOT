...
<ul>
<li style="list-style: none; margin-right: 110px;">
<img src="images/main/1.png" style="margin-right: 18px;">
<img src="images/main/2.png" style="margin-right: 18px;">
<img src="images/main/4.png" style="margin-right: 30px;">
<img src="images/main/6.png" style="margin-right: 10px;">
<img src="images/main/8.png" style="margin-left: 10px;">
</li>
<li style="list-style: none; margin-top:30px;">
<img src="images/main/10.png" style="margin-right: 30px;">
<img src="images/main/12.png">
<img src="images/main/14.png">
<img src="images/main/16.png" style="margin-left: 10px;">
<img src="images/main/18.png" style="margin-left: 10px;">
</li>
</ul>
</div>
</label>
<div align="center" style="margin-top: 75px;">
<h2 style="font-size: 40px;">신용 대출</h2>
<h6 style="margin-top: 20px; color:#8c8c8c; size: 1px;">직장인/사업자 신청가능한 대출상품</h6>
...
<!-- 서브 컨텐츠 내용 시작 -->
	...
	<li style="list-style: none; color: #808080">소득증빙이 가능한 성인 직장인/사업자</li>       
	...
	<li style="list-style: none; color: #808080">100만원 ~ 최대 <font color='red'>7000만원</font></li>
...
<!--왼쪽 약관동의 끝-->
		...
		<div align="center" style="margin-top: -200px; margin-bottom: 50px;">
		<button class="btn btn-primary-outline btn-xl page-scroll wow fadeInUp" onclick="location.href='hrefradioCheck(this.form)'">대출상담 신청하기</button>
		</div>
		<div align="center">
