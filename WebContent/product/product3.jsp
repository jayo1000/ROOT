...
<div align="center">
<!--  위 상품 전체를 잡는녀석 -->
<label style="border: 1px solid #cccccc; width: 820px; height: 330px; margin-bottom: 20px;">
...
<td colspan="4" align="center" style="font-size: 14px;">
            <label style="border:1px solid black; width: 680px; height: 141px; background-color: white;">
              ...
              <ul style="text-align: left;">
				<li style="list-style: none; padding-top:10px; padding-bottom: 20px; font-size: 23px; "> <label style="margin-left:20px;"></label>그린비 아파트 <i class="glyphicon glyphicon-home"></i><label style="margin-left:110px;"></label><a href="/product/product1.jsp" class="btn-primary-outline btn-xl page-scroll wow fadeInUp" style="font-size: 13px; padding: 10px 15px;">
...
<tr>
<td></td><td></td>
<td></td><td><h5 style="font-weight: bold; margin-top: 20px; text-align: right;">2087만원 / 3000만원</h5></td>
</tr>
</table>
</label>
