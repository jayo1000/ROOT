...
<label style="border: 1px solid #cccccc; width: 460px; height: 420px;">
<table>
<!-- 이미지는 맨위에 -->
<tr>
<td colspan="3"><img src="/images/index/main-3.png"></td>
</tr>
<!-- 상품 메인이름 -->
<tr>
<td colspan="3" style="padding-top: 10px; padding-bottom: 10px; padding-left: 8px;">
<font style="font-weight: bold;" size="5px;">코오룽 준비중</font>
</td>
</tr>
<!-- 상품 메인설명 -->
<tr>
<td style="padding-left: 10px; color: gray;">투자모집기간</td>
<td colspan="2" style="padding-left: 150px; color: gray;"> 2017-07-16 ~ 2017-07-16</td>
</tr>
<tr>
...
<td colspan="2" style="padding-top: 10px;"><h5 style="margin-left: 205px;">금액 2000만원</h5></td>
</tr>
</table>
</label>
...
<label style="border: 1px solid #cccccc; width:150px; height: 100px;  margin-right: 10px; margin-bottom: 20px;">
	...
	<li style="list-style: none; color: #808080">13.00%</li>       	
	</ul>
	</label></td>
	...
	<li style="list-style: none; color: #808080; margin-left: 10px;">12개월</li>       	
	</ul>
	</label>
	</td>
	...
	<li style="list-style: none; color: #808080">2000 만원</li>       	
	</ul>
	</label>
	</td>
	<td>
...
<tr>
<td></td><td></td>
<td></td><td><h5 style="font-weight: bold; margin-top: 20px;">2000만원 / 2000만원</h5></td>
</tr>
</table>
</label>
...
<div class="boardType1" style="margin-bottom: 100px; margin-top: 35px;">
			...
			<tbody>
				...
				<tr style="border-top:1px solid black; height: 40px;">
					...
					<td style="text-align: center;">20,000,000원</td>
				...
				<tr style="border-top:1px solid black; height: 40px;">
					...
					<td style="text-align: center;">매월 대출실행일의 응당일(월 단위 후최)</td>
					<td style="text-align: center;">213,698원(30일)<p style="font-weight: bold; margin-bottom: -5px;">220,821원(31일)</td>
...
<div class="contents left">
<div class="boardType1" style="margin-bottom: 100px; margin-top: 35px;">
			<table border="0" cellspacing="0" cellpadding="0" style="table-layout: fixed; border-collapse: collapse; border-spacing: 0; ">
			<colgroup>
				<col width="200px"/>
				<col width="200px"/>
				<col width="200px"/>
			...
			<tbody>
				<tr style="border-top:1px solid black; height: 40px; background-color: #e6e6e6;">
					<td colspan="2" style="text-align: center; width: 400px;">매물유형</td>
					<td colspan="2" style="text-align: center;  width: 400px;">건물면적/평형</td>
				</tr>
				<tr style="border-top:1px solid black; height: 40px;">
					<td colspan="2" style="text-align: center;  width: 400px;">아파트(후)</td>
					<td colspan="2" style="text-align: center;  width: 400px;">84.92/101.38m(31평)</td>
				</tr>
				<tr style="border-top:1px solid black; height: 40px; background-color: #e6e6e6;">
					<td colspan="2" style="text-align: center;  width: 400px;">담보 감정가</td>
					<td colspan="2" style="text-align: center;  width: 400px;">그린비 감정가</td>
				</tr>
				<tr style="border-top:1px solid black; height: 40px;">
					<td colspan="2" style="text-align: center;  width: 400px;">163,000,000원</td>
					<td colspan="2" style="text-align: center;  width: 400px;">155,000,000원</td>
				</tr>
				<tr style="border-top:1px solid black;">
				<td colspan="4"></td>
				</tr>
...
<div id="alertModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <button class="btn btn-primary btn-lg" data-dismiss="modal" aria-hidden="true" onclick="location.href='/product/product1.htm'">OK</button>
            </div>
        </div>
    </div>
</div>
