...
<label style="border:1px solid black; width: 680px; height: 141px; background-color: white; margin-top: 10px;">
           ...
           <span class="icon mdi mdi-basket"></span>자세히보기</a></li>
				...
				<li style="list-style: none; color: #808080; margin-bottom: -8px; "> <label style="margin-left:30px;"></label>예상 수익률 <label style="margin-left:25px; border-left: 1px solid #737373;">　</label><label style="margin-left:25px;"></label> 기간  
				...
				<li style="list-style: none; color: #808080; border-top: 1px solid #737373;"> <label style="margin-left:37px;"></label>9.57%  <label style="margin-left:53px; border-left: 1px solid #737373;">　</label><label style="margin-left:30px;"></label>12개월  
...
<div class="boardType1" style="margin-bottom: 100px; margin-top: 35px;">
			...
			<tbody>
				...
				<tr style="border-top:1px solid black; height: 40px;">
					...
					<td style="text-align: center;">197,260원(30일)<p style="font-weight: bold; margin-bottom: -5px;">203,835원(31일)</td>
...
<div class="boardType1" style="margin-bottom: 100px; margin-top: 35px;">
			...
			<tbody>
				...
				<tr style="border-top:1px solid black; height: 40px;">
					...
					<td colspan="2" style="text-align: center;">84.95/127.37m(37평)</td>
				</tr>
				<tr style="border-top:1px solid black; height: 40px; background-color: #e6e6e6;">
				...
				<tr style="border-top:1px solid black; height: 40px;">
					<td colspan="2" style="text-align: center;">287,500,000원</td>
					<td colspan="2" style="text-align: center;">260,000,000원</td>
				</tr>
				<tr style="border-top:1px solid black;">
				<td colspan="4"></td>
				</tr>
