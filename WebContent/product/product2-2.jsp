...
<!-- 이미지는 맨위에 -->
<tr>
<td colspan="3"><img src="/images/index/main-2.png"></td>
</tr>
<!-- 상품 메인이름 -->
<tr>
<td colspan="3" style="padding-top: 10px; padding-bottom: 10px; padding-left: 8px;">
<font style="font-weight: bold;" size="4px;">마리에드 준비중</font>
</td>
</tr>
<!-- 상품 메인설명 -->
<tr>
<td style="padding-left: 10px; color: gray;">투자모집기간</td>
<td colspan="2" style="padding-left: 150px; color: gray;"> 2017-07-17 ~ 2017-07-17</td>
</tr>
<tr>
<td style="padding-left: 10px; color: gray;">대출금액</td>
<td colspan="2" style="padding-left: 240px; color: #3399ff;"><h5>2,000만원</h5></td>
</tr>
<tr>
