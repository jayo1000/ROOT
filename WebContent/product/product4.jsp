...
<td colspan="4" align="center" style="font-size: 14px;">
              ...
              <ul style="text-align: left;">
				<li style="list-style: none; padding-top:10px; padding-bottom: 20px; font-size: 23px; "> <label style="margin-left:20px;"></label>연수구 아파트 <i class="glyphicon glyphicon-home"></i><label style="margin-left:110px;"></label><a href="/product/product2.jsp" class="btn-primary-outline btn-xl page-scroll wow fadeInUp" style="font-size: 13px; padding: 10px 15px;">
...
<tr>
<td></td><td></td>
<td></td><td><h5 style="font-weight: bold; margin-top: 20px; text-align: right;">668만원 / 5000만원 </h5></td>
</tr>
</table>
</label>
