...
<td colspan="4" align="center" style="font-size: 14px;">
            <label style="border:1px solid black; width: 680px; height: 141px; margin-top: 80px; background-color: white;">
              ...
              <ul style="text-align: left;">
				<li style="list-style: none; padding-top:10px; padding-bottom: 20px; font-size: 23px; "> <label style="margin-left:20px;"></label>도화동 주택단지 <i class="glyphicon glyphicon-home"></i><label style="margin-left:90px;"></label></li>
...
<tr>
<td></td><td></td>
<td></td><td><h5 style="font-weight: bold; margin-top: 20px; text-align: right;">442만원 / 700만원</h5></td>
</tr>
</table>
</label>
...
<div class="boardType1" style="margin-bottom: 100px; margin-top: 35px;">
			...
			<tbody>
				...
				<tr style="border-top:1px solid black; height: 40px;">
					...
					<td style="text-align: center;">266,301원(30일)<p style="font-weight: bold; margin-bottom: -5px;">275,178원(31일)</td>
...
<div class="boardType1" style="margin-bottom: 100px; margin-top: 35px;">
			...
			<tbody>
				...
				<tr style="border-top:1px solid black; height: 40px;">
					...
					<td colspan="2" style="text-align: center;  width: 400px;">59.99/84.05m(25평)</td>
				</tr>
				<tr style="border-top:1px solid black; height: 40px; background-color: #e6e6e6;">
				...
				<tr style="border-top:1px solid black; height: 40px;">
					<td colspan="2" style="text-align: center;  width: 400px;">215,000,000원</td>
					<td colspan="2" style="text-align: center;  width: 400px;">190,000,000원</td>
				</tr>
				<tr style="border-top:1px solid black;">
				<td colspan="4"></td>
				</tr>
