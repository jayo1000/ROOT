...
#error_content {width:350px; _width /**/:510px; height:206px; _height:208px; margin:0 auto; margin-top:50px; padding:0 0 0 214px; border:1px solid #e5e5e5; background:#FFF url(http://www.connectitus.nl/wp-content/uploads/2014/09/nee-kruis.jpg) no-repeat; text-align:left;}
...
<div id="error_content">
	<h2>시스템 장애가 발생하였습니다.<br>관리자(<a href="mailto:jayo1000@naver.com">jayo1000@naver.com</a>)에게 문의바랍니다.</h2>
	<div class="content">
