        ...
        <div class="row">
            <div class="col-lg-12 text-xs-center">
                ...
                <c:forEach var="list" items="${list}" >   
                 <h1 style="margin-bottom: 30px; font-size: 50px; margin-right: 40px; color: black;">&nbsp;${list.accumnloan}</label>억&nbsp; &nbsp;${list.accumnloan2}</label>만원</h1>
			        </c:forEach>
			  
			   <h1 style="margin-bottom: 30px; font-size: 50px; margin-right: 40px; color: black;">&nbsp;1587</label>억&nbsp; &nbsp;4850</label>만원</h1>
