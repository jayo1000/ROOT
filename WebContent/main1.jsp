...
<h6 style="margin-top: 20px; color:#8c8c8c; size: 1px;">보험설계사를 위한 간편대출</h6>
...
본 약관은 2014년 3월 1일부터 시행합니다.
				...
				<tr>
					...
					<td class="alignR pd_r30">
						<input type="radio" checked="checked" class="agree_1" title="동의함" name="agree" id="chkAgree" value="Y">
...
<!--왼쪽 약관동의 끝-->
		...
		<div align="center" style="margin-top: -200px; margin-bottom: 50px;">
		<button type="submit" class="btn btn-primary-outline btn-xl page-scroll wow fadeInUp" onclick="loan.htm">대출상담 신청하기</button>
		</div>
<!-- 		<div align="center">
