              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <img src="/images/butt/go.png"> <label style="border-bottom: groove;">담당자 계정 : <input type="text" value="<%=loginId%>" disabled="disabled" style="width: 100px;"> 님</label>
                   ...
                   <table style="width: 100%;border: 1px solid black; margin-bottom: 30px;">
                     ...
                     <th style="border: 1px solid black;"><input type="text" id="testDatepicker" name="endday" style="margin-left: 50px;" required>  </th>
