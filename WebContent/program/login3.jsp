...
<meta name="viewport" content="width=device-width, initial-scale=0.9, user-scalable=no,target-densitydpi=device-dpi,maximum-scale=1.0">
...
<body id="first">
<div class="container" id="lolo" style="margin: 400px auto; ">
	<div class="row">
	    <div class="col-md-4 col-md-offset-4 login">
           ...
           <!-- <div class="btn-group btn-group-justified" role="group" aria-label="...">
                ...
                <div class="btn-group" role="group">
                 ...
                 <div class="btn-group btn-group-justified" role="group" aria-label="...">
                  <div class="btn-group" role="group">
                    <button type="submit" id="lo" name="loginForm" class="btn btn-primary" style="padding-right: 85px; padding-left: 40px; margin: 0 110px;">Login</button>
                  </div>
                </div>
            </form>
            <hr>
