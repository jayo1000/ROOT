              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <select name="greenb_id" style="width: 100px; height: 50px; color: black;" required>
                   ...
                   <select name="plan" style="width: 100px; height: 50px; color: black; float: left; margin-top: 10px;" required>
						...
						<option value="1" id="g1">'출'플랜</option>
						<option value="2" id="g2">'매일' 플랜</option>
						<option value="3" id="g3">'매일2'플랜</option>
						<option value="4" id="g4">'월적' 플랜</option>
						<option value="5" id="g5">'임시' 플랜</option>
				</select>
				...
				<button type="button" style="width: 100px; height: 50px; color: black; float: left; margin-top: 10px;" onclick="solid()"><i class="glyphicon glyphicon-step-forward"></i>잔액계산</button>
                  ...
                  <img src="/images/butt/sang2.png" style="float: left; margin-bottom: 10px; margin-top: 10px;">
                   ...
                   <th style="border: 1px solid black; text-align: center;"><input type="text" style="width: 80%" placeholder="숫자만 기입해주세요" id="deposit" name="deposit" value="0"></th>
                   <th></th>
                   ...
                   <th style="border: 1px solid black; text-align: center;"><input type="text" style="width: 80%" placeholder="숫자만 기입해주세요" id="totalmoney" name="totalmoney" value="0"></th>
