...
.navbar {
  ...
  #mimin {
         background-image: url("/images/butt/back1.png");
...
<img src="/images/butt/soso.png" style="width: 300px; margin-bottom: -10px; margin-top: 10px;">
<h1 style="border-bottom: 1px solid #676869; margin-bottom: 20px; padding-bottom: 20px;">대출이자 계산기</h1>
...
<div class="col-md-6">
<table class="table table-condensed" style="width: 90%; box-shadow:-5px 5px 5px grey; box-shadow: 0 8px 15px 0 rgba(0, 0, 10, 0.2), 0 6px 20px 0 rgba(0, 0, 10, 0.19); border: 1px solid #676869; background-color: white; border-collapse: inherit;">
...
<table class="table table-bordered" style="width:91%; box-shadow:-5px 5px 5px grey; box-shadow: 0 8px 15px 0 rgba(0, 0, 10, 0.2), 0 6px 20px 0 rgba(0, 0, 10, 0.19); border: 1px solid #676869; background-color: white; border-collapse: inherit; margin-right: 10px; margin-top: 30px;">
<tbody><tr><td colspan="2" style="text-align:center;font-size:1.3em;font-weight:700;">원금 및 총 이자액 합계</td></tr>
<tr><td colspan="2" style="height: 50px;text-align:center;font-size:1.3em;font-weight:700;color:#ff0000;" id="allsum1" name="total">0 원</td></tr>
<tr><td style="height: 50px;">총이자액</td>
<td id="allsum2" name="totalinterest">0 원</td></tr>
<tr><td style="height: 50px;">월 상환금</td>
<td id="allsum3" name="payment">0 원</td></tr>
<tr><td colspan="2" style="height: 50px;">월상환금 = 원금 + 이자</td></tr>
</tbody></table>
</div>
</form>
</div>
<br><br><br>
<div align="center">
                   <button class="ripple-infinite btn-round btn-3d btn-default" style="width: 250px; height: 50px; margin-top: -50px;" onclick="location.href='javascript:history.go(-1)';">돌아가기</button>                   
                   </div>
<br><br>
<br><br>
<p style="width:100%;height:50px;line-height:50px;background:#DDD;">
각종 계산서식  Greenbloan.com  & 메인 디자인 : 심은지   
</p>
</center>
<!-- start: Javascript -->
