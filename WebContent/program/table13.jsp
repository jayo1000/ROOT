...
<td><input type="text" name="month" maxlength="3" value="" class="inp1 onlyNum" style="width:110px;" required="required" id="years" onchange="calculate();"> 개월<br>
...
<td><input type="text" name="term" id="term" maxlength="3" value="" disabled="" style="background-color:#ddd;width:110px" class="inp1 onlyNum"> 년<br>
...
<td><input type="text" name="rate" maxlength="7" value="" class="inp1 float" required="required" id="rate" onchange="calculate();"> %<br>
...
<div class="col-md-4">
<table class="table table-bordered" style="border: 1px solid black; border-collapse: inherit; margin-right: 10px;">
