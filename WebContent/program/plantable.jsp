...
<c:when test="${cookie.loginId.value eq 'inchen'}" >
                    <li><img src="/images/butt/glogo.png"></li>
                    <li id="server_time">
                      <!-- <h1 class="animated fadeInLeft">21:00</h1>
                      <p class="animated fadeInRight">토요일, 팔월 1일 2029년</p> -->
                    ...
                    <li class="ripple" style="background-color: ">
                     ...
                     <li class="ripple" style="background-color: ">
                      <a class="tree-toggle nav-header">
                        <span class="fa-area-chart fa"></span>인천 내역
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                     <li><a href="/memberlist.htm?greenb_id=1"><span class="fa fa-table"></span>인천 전체내역(I)</a></li>                     
                      </ul>
                    </li>
                     <li class="ripple">
                      <a class="tree-toggle nav-header">
...
<c:when test="${cookie.loginId.value eq 'gangju'}" >
 <li><img src="/images/butt/glogo.png"></li>
                    <li id="server_time">
                      <!-- <h1 class="animated fadeInLeft">21:00</h1>
                      <p class="animated fadeInRight">토요일, 팔월 1일 2029년</p> -->
                    ...
                    <li class="ripple" style="background-color: ">
                      <a href="/memberlist.htm?greenb_id=2">
                        <span class="fa-area-chart fa"></span>광주 명부
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>                     
                    </li>
                      <li class="ripple">
                      <a href="/memberlist.htm?greenb_id=2">
                        <span class="fa-area-chart fa"></span>광주 내역
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                    </li>
                     <li class="ripple">
  ...
  <!-- <div class="container"> -->
    <div class="navbar-header">
     <a class="menu"><i class="fa fa-bars" id="menu_icon"></i></a>
      <a class="navbar-brand" href="/alllist.htm">
      GREENB-LOAN
...
<!-- <li><a href="#" class="opener-right-menu"><span class="fa fa-coffee"></span></a></li> -->
      ...
      <c:otherwise>
      <ul class="nav navbar-nav navbar-right user-nav" style="margin-right: 40px;">
                <li class="user-name"><span>접속불가</span></li>
              </ul>
      </c:otherwise>
      </c:choose>
            ...
            <div id="content">
             <div class="panel box-shadow-none content-header">
                  <div class="panel-body" style="border: 2px solid white;">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft"><img src="/images/butt/main-jang.png" style="margin-left: -35px;"></h3>
                        <p class="animated fadeInDown">
                          User <span class="fa-angle-right fa"></span> User Data Tables
                        </p>
                         <div class="span12">
            <form id="custom-search-form" class="form-search form-horizontal pull-right" action="/search.htm" >
        ...
        <div class="panel panel-primary filterable" style="margin-bottom: 20px;">
         ...
         <form action="" id="setRows" style="margin-bottom: -10px;">
            <p style="font-size: 20px; font-weight: bold; text-align: right; height: 50px; padding-top: 10px; margin-right: 20px; "> <!-- background-color: #0E1A35; color:white; -->
                ...
                <input type="text" name="rowPerPage" value="30" style="color: black; width: 50px; height: 30px; ">
               <font> 줄 씩 표시합니다.</font>
            </p>
        </form> 
            <table class="table" style="margin: auto;" id="products" role="grid">
                <thead>
                    <tr class="filters" id="pix">
                        <th style="hegith:40px;"><input type="text" class="form-control" placeholder="순번" id="1" disabled style="font-size: 16px; font-weight: bold; margin-left: 5px;"></th>
                        <th id="2"><input type="text" class="form-control" placeholder="이름" disabled style="font-size: 16px; font-weight: bold;"></th>
                        <th id="3"><input type="text" class="form-control" placeholder="날짜" disabled style="font-size: 16px; font-weight: bold;"></th>
                        <th id="4"><input type="text" class="form-control" placeholder="대출액" disabled style="font-size: 16px; font-weight: bold;"></th>
                        <th id="5"><input type="text" class="form-control" placeholder="입금액" disabled style="font-size: 16px; font-weight: bold;"></th>
                        <th id="6"><input type="text" class="form-control" placeholder="플랜명" disabled style="font-size: 16px; font-weight: bold;"></th>
                        <th id="7"><input type="text" class="form-control" placeholder="잔액" disabled style="font-size: 16px; font-weight: bold;"></th>
                        <th id="8"><input type="text" class="form-control" placeholder="사원코드" disabled style="font-size: 16px; font-weight: bold;"></th>             
                    </tr>
                </thead>
                <tbody>
