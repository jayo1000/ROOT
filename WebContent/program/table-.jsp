...
<div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3><span class="glyphicon glyphicon-th-list"></span>&nbsp; The registration account book Program ( 등록 장부 관리 ) </h3>
                    <h4 style="display: inline-table;">총 명부수 [<font id="count"></font>]</h4></div>
...
<button class="btn btn-outline btn-default" style="padding: 20px 30px; font-weight: bold;" onclick="play()">실시간 총 금액</button>
                    ...
                    <td class="m1" id="m1">
<h4 style="font-weight: bold; color:#3399ff">총 입금액  [  <font id="sum1" color="black"></font>  ] 원 </h4></td><td class="m1" id="m2">   <h4 style="font-weight: bold; color:#3399ff"> 총 나갈금액[  <font id="sum2" color="black"></font>  ] 원  </h4></td>
            ...
            <table class="table" style="margin: auto;">
                <thead>
                    <tr class="filters" id="pix">
                        <th style="hegith:40px;"><input type="text" class="form-control" placeholder="이름" id="1" disabled></th>
                ...
                <tbody>
                 <c:forEach var="list" items="${list}">					
                    <tr id="one">
                        ...
                        <td>${list.bank}</td>
                        <td id="banknum"><a	href="<c:url value='/memberinfo.htm'>
                        <c:param name="member_num" value="${list.member_num }" /></c:url>">${list.banknumber}</a></td>
                        ...
                        <td>${list.givenumber}</td>                        
                        <td><input name="oneday" id="oneday" value="${list.onedaymoney}"></td>                 
                        <td><input name="give"  id="give" value="${list.givemoney}"></td>                      
