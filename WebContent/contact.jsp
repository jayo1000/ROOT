...
<!-- header -->
<div align="center" style="margin-top: 90px; margin-bottom: 130px;">
<h2 style="font-size: 40px;">이용문의</h2>
<h6 style="margin-top: 20px; color:#8c8c8c; size: 1px;">이용에 문의사항이 있으신가요?</h6>
<h6 style="margin-top: 20px; color:#8c8c8c; size: 1px;">신속하고 정확하게 답변해드립니다.</h6>

<div class="boardType1" style="margin-bottom: 100px; margin-top: 65px;">
			...
			<tbody>
				<tr style="border-top:1px solid black; height: 60px;">
					<td style="padding-left: 75px; font-size: 15px;" width="200px;">투자 및 제휴</th>
					<td colspan="2" style="padding-left: 50px; font-size: 15px;" width="300px;">032-215-9926</td>
				</tr>
				<tr style="border-top:1px solid black; height: 50px;">
					<td style="padding-left: 75px; font-size: 15px;" width="200px;">대출</th>
					<td colspan="2" style="padding-left: 50px; font-size: 15px;" width="300px;">032-215-9926</td>
				</tr>
				<tr style="border-top:1px solid black; height: 60px;">
					<td style="padding-left: 75px; font-size: 15px;" width="200px;">전화</th>
					<td colspan="2" style="padding-left: 50px; font-size: 15px;" width="300px;">032-215-9926</td>
				</tr>
				<tr style="border-top:1px solid black; height: 60px;">
					<td style="padding-left: 75px; font-size: 15px;" width="200px;">팩스</th>
					<td colspan="2" style="padding-left: 50px; font-size: 15px;" width="300px;">032-215-9922</td>
				</tr>
				<tr style="border-top:1px solid black; height: 60px;">
					<td style="padding-left: 75px; font-size: 15px;" width="200px;">운영시간</th>
					<td colspan="2" style="padding-left: 50px; font-size: 15px;" width="300px;">평일오전 10시 ~ 오후 6시</td>
				</tr>
