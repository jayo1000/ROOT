                ...
                <div class="col-md-12">
                  <div class="panel">
                   ...
                   <table style="width: 100%;border: 1px solid black; margin-bottom: 30px;">
                     ...
                     <th style="border: 1px solid black; "><input type="text" style="margin-left: 50px;" value="${member.member_num}"></th>
                     <th style="border: 1px solid black; text-align: center; width: 80px;">이름</th>
                     <th style="border: 1px solid black;"><input type="text" style="margin-left: 50px;" value="${member.name}"></th>
                     <th style="border: 1px solid black; text-align: center; width: 80px;">가입날짜</th>
                     <th style="border: 1px solid black;"><input type="text" style="margin-left: 50px;" value="${member.beginday}"></th>
                   </tr>
                   <tr>
                    <th style="border: 1px solid black; text-align: center; height: 50px;">생년월일</th>
                     <th style="border: 1px solid black;"><input type="text" style="margin-left: 50px;" value="${member.endday}"></th>
                     <th style="border: 1px solid black; text-align: center;">상호</th>
                     <th style="border: 1px solid black;"><input type="text" style="margin-left: 50px;" value="${member.bank}"></th>
                     <th style="border: 1px solid black; text-align: center;">연락처</th>
                     <th style="border: 1px solid black;"><input type="text" style="margin-left: 50px;" value="${member.banknumber}"></th>
                   </tr>
                   <tr>
...
<button class="ripple-infinite btn-round btn-3d btn-default" style="width: 120px; height: 50px; margin-right: 15px;">수정하기</button>
                   </div>
                   </div>             
</div>
</div>
