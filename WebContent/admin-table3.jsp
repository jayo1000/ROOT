...
<div class="container">
    <h2 style="text-align: center; color: white; margin-top: 40px; font-weight: bold;">투자정보 신청 고객 테이블</h2>
    <hr>
    <div class="row" >
        <div class="panel panel-primary filterable" style="margin-bottom: 40px;">
            <div class="panel-heading">
                <h3 class="panel-title" style="text-align: center">메인 투자정보 신청 고객목록</h3>
