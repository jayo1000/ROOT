...
<div class="container">
    <h2 style="text-align: center; color: white; margin-top: 40px; font-weight: bold;">홈페이지 회원 가입 테이블</h2>
    <hr>
    <div class="row" >
        <div class="panel panel-primary filterable" style="margin-bottom: 40px;">
            <div class="panel-heading">
                <h3 class="panel-title" style="text-align: center">홈페이지 회원 가입 고객목록</h3>
                <div class="pull-right">
                    <button class="btn-default btn-xs btn-filter"><span class="glyphicon glyphicon-filter"></span>검색</button>
                </div>
            </div>
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="직업" disabled></th>
                        <th><input type="text" class="form-control" placeholder="연락처" disabled></th>
                        <th><input type="text" class="form-control" placeholder="신청날짜" disabled></th>
                    </tr>
                </thead>
                <tbody>
				<c:forEach var="list" items="${list}" >							
                    <tr>
                        ...
                        <td>${list.name }</td>
                        <td>${list.job}</td>
                        <td>0${list.phonenumber1}-${list.phonenumber2}-${list.phonenumber3}</td>                    
                        <td>${list.date}</td>
                    </tr>
                    </c:forEach>
                </tbody>
