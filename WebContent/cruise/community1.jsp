		...
		<td align="center"><table width="980" border="0" cellspacing="0" cellpadding="0">
			<tbody><tr valign="top" align="left">
				<td width="266" class="cont_left"><table width="252" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class="leftnevi">
							<a href="/cruise/community1.jsp" onfocus="blur()" class="on">여행후기</a><br>
				...
				<p style="margin-top:20px; padding-bottom:80px;"><img src="/images/cruise/logo/shortcut.png" alt=" " border="0" usemap="#left_banner">
					<map name="left_banner" id="left_banner">
						...
						<area shape="rect" coords="133,3,197,103" href="http://www.localhost/" target="_blank" onfocus="blur()">
					</map>
				</p></td>
				<td width="714" style="padding-top:66px;"><p style="position:relative; width:714px; height:180px; margin-bottom: 0px;"><img src="/images/cruise/logo/sub04-01.png" align="left"></p>
