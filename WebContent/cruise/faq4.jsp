	...
	<tr valign="top">
		<td align="center"><table width="980" border="0" cellspacing="0" cellpadding="0">
			<tbody><tr valign="top" align="left">
				<td width="266" class="cont_left"><table width="252" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class="leftnevi">
							...
							<a href="/cruise/faq4.jsp" onfocus="blur()" class="on" >디지털앨범CD신청</a></td>
					</tr>
				</tbody></table>
				...
				<td width="714" style="padding-top:66px;"><p style="position:relative; width:714px; height:180px; margin-bottom: 0px;"><img src="/images/cruise/logo/sub05-04.png" align="left"></p>
<table border="0" cellspacing="0" cellpadding="0" class="search_table" style="width: 100%; margin-bottom: 5px;">
<form name="searching" action="/images/cruise/logo/sub05-04.png" method="post"></form>
	<tbody><tr>
		<td id="td" style="padding-left: 1px; padding-bottom:10px;"></td>
		<td align="right">
