	...
	<tr valign="top">
		<td align="center"><table width="980" border="0" cellspacing="0" cellpadding="0">
			<tbody><tr valign="top" align="left">
				<td width="266" class="cont_left"><table width="252" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class="leftnevi">
							...
							<a href="/cruise/community2.jsp" onfocus="blur()" class="on">동영상갤러리</a><br>
							<a href="/cruise/community3.jsp" onfocus="blur()">포토갤러리</a><br>
					</tr>
				</tbody></table>
				...
				<td width="714" style="padding-top:66px;"><p style="position:relative; width:714px; height:180px; margin-bottom: 0px;"><img src="/images/cruise/logo/sub04-02.png" align="left"></p>
...
<form name="searching" action="/images/cruise/logo/sub04-01.png" method="post"></form>
	<tbody><tr>
		<td id="td" style="padding-left: 1px; padding-bottom:10px;"><span class="search_span"><i class="glyphicon glyphicon-flag" style="margin-right: 5px;"></i>총 <span class="search_em">3건</span>의 글이 있습니다.</span></td>
		<td align="right">
...
<table border="0" cellspacing="0" cellpadding="0" class="board_list" style="width: 100%;">
	...
	<tr style="border-bottom-style: dotted;">
		<td id="td">3</td>
		<td class="left_text">
		<a href="/sub05/sub05_1.php?mode=view&amp;idx=22&amp;page=1">그린비라이프 제주도투어 동영상</a>
				</td>
		<td id="td">2017-08-30</td>
		<td  id="td">4</td>
	</tr>
	...
	<tr style="border-bottom-style: dotted;">
		<td id="td">2</td>
		<td class="left_text">
		<a href="/sub05/sub05_1.php?mode=view&amp;idx=20&amp;page=1">그린비라이프 경주 동영상</a>
				</td>
	...
	<tr style="border-bottom-style: dotted;">
		<td id="td">1</td>
		<td class="left_text">
		<a href="/sub05/sub05_1.php?mode=view&amp;idx=19&amp;page=1">그린비라이프 서울관광 투어 동영상 </a>
				</td>
		<td id="td">2015-02-12</td>
		<td id="td">72</td>
	</tr>
