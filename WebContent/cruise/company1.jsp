		...
		<td align="center"><table width="980" border="0" cellspacing="0" cellpadding="0">
			<tbody><tr valign="top" align="left">
				<td width="266" class="cont_left"><table width="252" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class="leftnevi">
							<a href="/cruise/company1.jsp" onfocus="blur()" class="on">회사소개</a><br>
							<a href=/cruise/company2.jsp onfocus="blur()">찾아오시는길</a><br>
					</tr>
				</tbody></table>
				...
				<td width="714" style="padding-top:66px;"><p style="position:relative; width:714px; height:180px; margin-bottom: -20px;"><img src="/images/cruise/logo/sub01-1.png" align="left"></p>


<img src="/images/cruise/company.png" style="margin-bottom: 80px;">
				</td>
			</tr>
		</tbody></table>
		</td>
