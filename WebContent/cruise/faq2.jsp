	...
	<tr valign="top">
		<td align="center"><table width="980" border="0" cellspacing="0" cellpadding="0">
			<tbody><tr valign="top" align="left">
				<td width="266" class="cont_left"><table width="252" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class="leftnevi">
							...
							<a href="/cruise/faq2.jsp" onfocus="blur()" class="on">묻고 답하기</a><br>
				...
				<td width="714" style="padding-top:66px;"><p style="position:relative; width:714px; height:180px; margin-bottom: 0px;"><img src="/images/cruise/logo/sub05-02.png" align="left"></p>
<table border="0" cellspacing="0" cellpadding="0" class="search_table" style="width: 100%">
<form name="searching" action="/images/cruise/logo/sub05-02.png" method="post"></form>
	<tbody><tr>
		<td id="td" style="padding-left: 1px; padding-bottom:10px;"><span class="search_span"><i class="glyphicon glyphicon-flag" style="margin-right: 5px;"></i>총 <span class="search_em">4건</span>의 글이 있습니다.</span></td>
		<td align="right">
...
<table border="0" cellspacing="0" cellpadding="0" class="board_list" style="width: 100%">
	...
	<tr style="border-bottom-style: dotted;">
		<td id="td">4</td>
		<td class="left_text">
		<a href="/sub05/sub05_1.php?mode=view&amp;idx=18&amp;page=1">신청서는 어디서받나요?</a>
				</td>
		<td id="td">2016-11-05</td>
		<td id="td">2</td>
	</tr>
	...
	<tr style="border-bottom-style: dotted;">
		<td id="td">3</td>
		<td class="left_text">
		<a href="/sub05/sub05_1.php?mode=view&amp;idx=17&amp;page=1">언제떠날수있는지 확인 부탁드립니다.</a>
				</td>
		<td id="td">2016-03-02</td>
		<td id="td">5</td>
	</tr>
	...
	<tr style="border-bottom-style: dotted;">
		<td id="td">2</td>
		<td class="left_text">
		<a href="/sub05/sub05_1.php?mode=view&amp;idx=16&amp;page=1">할인은 얼마나 받을수 있나요?</a>
				</td>
		<td id="td">2015-06-24</td>
		<td id="td">10</td>
	</tr>
	...
	<tr style="border-bottom-style: dotted;">
		<td id="td">1</td>
		<td class="left_text">
		<a href="/sub05/sub05_1.php?mode=view&amp;idx=16&amp;page=1">여행은 어느 나라 까지 갈 수 있는지</a></td>
		<td id="td">2015-06-10</td>
		<td id="td">54</td>
	</tr>
...
<!-- 	<tr style="border-bottom-style: dotted;">
		<td id="td">1</td>
		<td class="left_text">
		<a href="/sub05/sub05_1.php?mode=view&amp;idx=15&amp;page=1">여행은 어디 까지 갈 수 있는지..</a>
				</td>
		<td id="td">2015-06-08</td>
		<td id="td">50</td>
	</tr> -->
...
<p style="text-align:center; width:706px;"><button>1</button>
</p>
<p style="margin-bottom:80px; text-align:center; width:706px;"><button class="btn-default" style="width: 100px; height: 35px;"><span class="glyphicon glyphicon-pencil" style="padding-right: 5px;"></span>글쓰기</button>
</p>
				</td>
			</tr>
		</tbody></table>
