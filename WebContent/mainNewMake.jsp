...
<body>
<label style="width: 100%; background-color: #d9d9d9; height: 50px;">
<a class="brand" href="/" style="font-size: 30px; padding-left: 30px;">GreenB</a>
<ul class="nav navbar-nav pull-xs-right" style="padding-right: 85px;">
          <li class="dropdown"><a href="#" class="dropdown-toggle"
			...
			<ul class="dropdown-menu" role="menu">
					...
					<li class="divider"></li>
					<li><a class="nav-link page-scroll" href="#aboutModal" style="padding-left: 15px;">로그인</a></li>
...
<a href="main1.jsp" class="btn btn-lg green" style="padding: 15px 40px; border-radius: 7px; margin-right: 5px;">보험설계자 대출<span class="box"></span></a>
...
<a href="main3.jsp" class="btn btn-lg green" style="border-radius: 7px; margin-right: 5px;">개인회생 대출<span class="box"></span></a>
<li style="list-style: none; margin-top: 10px;">
<a href="main4.jsp" class="btn btn-lg green" style="margin-left: -1px; border-radius: 7px; margin-right: 5px;">&nbsp;주부/여성 대출&nbsp;&nbsp;<span class="box"></span></a>
<a href="main4.jsp" class="btn btn-lg green" style="border-radius: 7px; margin-right: 5px;">&nbsp;&nbsp;&nbsp;직장인 대출&nbsp;&nbsp;&nbsp;&nbsp;<span class="box"></span></a>
<a href="main6.jsp" class="btn btn-lg green" style="border-radius: 7px; margin-right: 5px;">보증인 대출<span class="box"></span></a>
<a href="main7.jsp" class="btn btn-lg green" style="border-radius: 7px; margin-right: 5px;">&nbsp;&nbsp;소액 대출&nbsp;&nbsp;<span class="box"></span></a>
<a href="main3.jsp" class="btn btn-lg green" style="border-radius: 7px; margin-right: 5px;">프리랜서 대출<span class="box"></span></a>
</li>
</ul>
</div>
<div align="center" style="margin-top: 75px;">
<h2 style="font-size: 40px;">보험설계자 대출</h2>
<h6 style="margin-top: 20px; color:#8c8c8c; size: 1px;">보험설계자가 직접 관리해주는 안전한 대출</h6>
...
<!-- 서브 컨텐츠 내용 시작 -->
	...
	<li style="list-style: none; color: #808080">만19세이상의 간편하고</li>       
	<li style="list-style: none; color: #808080">빠른 대출 서비스를 원하는 고객 누구나</li>	
	</ul>
	</label>
...
<div class="boardType1">
			...
			<tbody>
				<tr style="border-top:5px solid black; border-left: ">
					<th style="background-color: #e6e6e6; padding-left: 30px;">이름</th>
					<td style="padding-left: 20px;"><input type="text" id="txtName" name="txtName" value="" maxlength="16" title="이름 입력" style="width:320px;"/></input></td>
				</tr>
				<tr style="border-top:1px solid black;">
					<th style="background-color: #e6e6e6; padding-left: 30px;">휴대폰</th>
					<td style="padding-left: 20px;">
						<select title="휴대폰 번호 앞자리 선택" id="ddlMobilePhone2" name="ddlMobilePhone" style="width:95px">
				   ...
				   --><input type="text" id="txtMobilePhone2" name="txtMobilePhone2" maxlength="4" title="휴대폰 번호 중간자리 입력" style="width:90px;"/></input><!-- 
				   --><span class="noun">-</span><!-- 
				   --><input type="text" id="txtMobilePhone3" name="txtMobilePhone3" maxlength="4" title="휴대폰 번호 뒷자리 입력" style="width:90px;"/></input>
					</td>
				</tr>
				<tr style="border-top:1px solid black;">
					<th style="background-color: #e6e6e6; padding-left: 30px;">필요금액</th>
					<td style="padding-left: 20px;"><input type="text" id="iWantAmount" name="iWantAmount" value="" maxlength="16" title="필요금액 입력" style="width:320px;"/></input> 만원</td>
				</tr>
